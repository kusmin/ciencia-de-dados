...
# Podemos utilizar a distribuição geométrica acumulada para saber qual a probabilidade
# do primeiro sucesso
...
####
#########################################
# Exemplo: Uma loja recebe em média, 6 (𝝺) clientes por minuto. Qual a probabilidade
# de que 5(x) clientes
#entrem em um minuto?
dpois(x= 5,lambda = 6)
...
# Também podemos obter a probabilidade acumulada de até 5 clientes entrarem na loja
# em um minuto
...
# Ao selecionar aleatoriamente um indivíduo dessa população, qual a probabilidade de
# ter salário entre
#2.400 e 2.600 ?
...
#Podemos gerar 100 números aleatórios para uma distribuição normal com média 2500
# e desvio padrão 170
...
#########################################
#Gera
# uma amostra aleatória de 1000 números seguindo uma distribuição qui-
#  quadrado
